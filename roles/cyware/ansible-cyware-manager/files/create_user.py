...
try:
    from cyware.rbac.orm import check_database_integrity
    from cyware.security import (
        create_user,
        get_users,
        get_roles,
        set_user_role,
    ...
    logging.error("No module 'cyware' found.")
    sys.exit(1)
...
if __name__ == "__main__":
    ...
    if username not in initial_users:
        ...
        # modify an existing user ("cyware" or "cyware-wui")
    ...
    #for def_user in ['cyware', 'cyware-wui']:
